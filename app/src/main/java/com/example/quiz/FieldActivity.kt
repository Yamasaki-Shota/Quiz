...
class FieldActivity : AppCompatActivity() {
    ...
    internal var quizData = arrayOf(
        ...
        arrayOf("station","えき"),
        arrayOf("bank","ぎんこう"),
        arrayOf("supermarket","すーぱーまーけっと"),
        arrayOf("gas station","がそりんすたんど"),
        arrayOf("firehouse","しょうぼうしょ"),
        arrayOf("hospital","びょういん"),
        arrayOf("post office","ゆうびんきょく"),
        arrayOf("school","がっこう"),
        arrayOf("library","としょかん"),
        arrayOf("amusement park","ゆうえんち"),
        arrayOf("laundry","くりーにんぐてん"),
        arrayOf("police box","こうばん"),
        arrayOf("restaurant","れすとらん"),
        arrayOf("bridge","はし"),
        arrayOf("tower","とう"),
        arrayOf("park","こうえん"),
        arrayOf("theater","えいがかん"),
        arrayOf("hotel","ほてる"),
        arrayOf("museum","はくぶつかん"),
        arrayOf("shrine","じんじゃ")
    ...
    internal var animal =
        arrayOf("えき","ぎんこう","すーぱーまーけっと","がそりんすたんど","しょうぼうしょ","びょういん","ゆうびんきょく","がっこう"
            ,"としょかん","ゆうえんち","くりーにんぐてん","こうばん","れすとらん","はし","とう","こうえん","えいがかん","ほてる","はくぶつかん","じんじゃ")

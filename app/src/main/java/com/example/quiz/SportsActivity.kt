...
class SportsActivity : AppCompatActivity() {
    ...
    internal var animal =
        arrayOf("てにす","やきゅう","さっかー","ごるふ","だんす","らぐびー","りくじょう","すきー","すのーぼーど","すいえい"
            ,"ぼくしんぐ","ばどみんとん","たっきゅう","ばれーぼーる","たいそう","すけーと","さーふぃん","ぼーりんぐ","どっぢぼーる","ばすけっとぼーる")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in quizData.indices) {
            ...
            for(j in 0..2){
                ...
                }while(animal[random_s[j]] == quizData[i][1] || random_s[0] == random_s[1] || random_s[1] == random_s[2] || random_s[2] == random_s[0])
            }

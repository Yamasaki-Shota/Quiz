...
class ShuffleJActivity : AppCompatActivity() {
    ...
    internal var animal =
        arrayOf("cat","monkey","bird","mouse","fox","panda","goat","pig","deer","lion",
            "tiger","mole","giraffe","bear","rabbit","sheep","snake","dog","elephant","cow")

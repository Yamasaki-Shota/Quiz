...
class EatActivity : AppCompatActivity() {
    ...
    internal var quizData = arrayOf(
        ...
        arrayOf("butter","ばたー"),
        arrayOf("cake","けーき"),
        arrayOf("candy","きゃんでぃー"),
        arrayOf("cheese","ちーず"),
        arrayOf("chocolate","ちょこれいと"),
        arrayOf("cookie","くっきー"),
        arrayOf("corn","とうもろこし"),
        arrayOf("egg","たまご"),
        arrayOf("jam","じゃむ"),
        ...
        arrayOf("carrot","にんじん"),
        arrayOf("rice","こめ"),
        arrayOf("potato","じゃがいも"),
        arrayOf("salad","さらだ"),
        arrayOf("sandwich","さんどうぃっち"),
        arrayOf("bean","まめ"),
        arrayOf("fish","さかな"),
        arrayOf("honey","はちみつ")
    ...
    internal var animal =
        arrayOf("とまと","ぱん","ばたー","けーき","きゃんでぃー","ちーず","ちょこれいと","くっきー","とうもろこし","たまご"
            ,"じゃむ","にく","にんじん","こめ","じゃがいも","さらだ","さんどうぃっち","まめ","さかな","はちみつ")

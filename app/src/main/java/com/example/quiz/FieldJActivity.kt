...
class FieldJActivity : AppCompatActivity() {
    ...
    internal var animal =
        arrayOf("station","bank","supermarket","gas station","firehouse","hospital","post office","school"
            ,"library","amusement park","laundry","police box","restaurant","bridge","tower","park","theater","hotel","shrine")

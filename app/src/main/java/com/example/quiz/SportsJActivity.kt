...
class SportsJActivity : AppCompatActivity() {
    ...
    internal var quizData = arrayOf(
        ...
        arrayOf("tennis","てにす"),
        arrayOf("baseball","やきゅう"),
        arrayOf("soccer","さっかー"),
        arrayOf("golf","ごるふ"),
        arrayOf("dance","だんす"),
        arrayOf("rugby football","らぐびー"),
        arrayOf("track and field","りくじょう"),
        arrayOf("ski","すきー"),
        arrayOf("snowboard","すのーぼーど"),
        arrayOf("swimming","すいえい"),
        arrayOf("boxing","ぼくしんぐ"),
        arrayOf("badminton","ばどみんとん"),
        arrayOf("table tennis","たっきゅう"),
        arrayOf("volleyball","ばれーぼーる"),
        arrayOf("gymnastics","たいそう"),
        arrayOf("surfing","さーふぃん"),
        arrayOf("ice skating","すけーと"),
        arrayOf("bowling","ぼーりんぐ"),
        arrayOf("dodge ball","どっぢぼーる"),
        arrayOf("basketball","ばすけっとぼーる")

    )
    internal var animal =
        arrayOf("tennis","baseball","soccer","golf","dance","rugby football","track and filed","ski","snowboard","swimming"
            ,"boxing","badminton","table tennis","volleyball","gymnastics","surfing","ice skating","bowling","dodge ball","basketball")

...
class EatJActivity : AppCompatActivity() {
    ...
    internal var animal =
        arrayOf("tomato","bread","butter","cake","candy","cheese","chocolate","cookie","corn","egg"
            ,"jam","meat","carrot","rice","potato","salad","sandwich","bean","fish","honey")
